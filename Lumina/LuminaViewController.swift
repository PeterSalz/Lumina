...
/// The main class that developer should interact with and instantiate when using Lumina.
public final class LuminaViewController: UIViewController
{
    ...
    var zoomRecognizer: UIPinchGestureRecognizer
    {
        ...
        let recognizer = UIPinchGestureRecognizer(target: self,
                                                  action: #selector(handlePinchGestureRecognizer(recognizer:)))
    ...
    var focusRecognizer: UITapGestureRecognizer
    {
        ...
        let recognizer = UITapGestureRecognizer(target: self,
                                                action: #selector(handleTapGestureRecognizer(recognizer:)))
        recognizer.delegate = self
    ...
    /**
        ...
        - Note: Responds live to being set at any time, and will
    ...
    */
    ...
    /**
        Set this to choose whether or not Lumina will be able to record video by
        holding down the capture button.
 
        Note: Responds live to being set at any time, and will update automatically.
 
        Warning: This setting takes precedence over video data streaming - if this
        is turned on, frames cannot be streamed, nor can CoreML be used via Lumina's
        recognizer mechanism.
    */
    ...
    /**
        Set this to choose whether or not Lumina will stream video frames through
        the delegate.
    ...
    */
    ...
    /**
        Set this to choose whether or not Lumina will stream machine readable
        metadata through the delegate.
    ...
    */
    ...
    /**
        Lumina comes ready with a view for a text prompt to give instructions to
        the user, and this is where you can set the text of that prompt.
 
        Note: Responds live to being set at any time, and will update automatically.
 
        Warning: If left empty, or unset, no view will be present, but view will be
        created if changed.
    */
    open var textPrompt = ""
    {
    ...
    /**
        Set this to choose a resolution for the camera at any time - defaults to
        highest resolution possible for camera.
    ...
    */
    ...
    /**
        Set this to choose a frame rate for the camera at any time - defaults to 30
        if query is not available.
    ...
    */
    ...
    /**
        A collection of model types that will be used when streaming images for
        object recognition.
    ...
    */
    open var streamingModelTypes: [AnyObject]?
    {
        didSet
        {
            if #available(iOS 11.0, *)
            {
                ...
                guard let types = streamingModelTypes else { return }
                ...
                for type in types
                {
                    ...
                    {
                        guard let model = value as? MLModel else { continue }
    ...
    /**
        The maximum amount of zoom that Luminca can use.
 
        Note: Default value will rely on whatever the active device can handle, if
    ...
    */
    ...
    /**
        Set this to decide whether live photos will be captured whenver a still image
        is captured.
    ...
    */
    ...
    /**
        Set this to apply a level of logging to Lumina, to track activity within
        the framework.
    */
    ...
    /**
        Returns a string of the version of Lumina currently in use,
    ...
    */
    open class func getVersion() -> String?
    {
        ...
        guard let versionString = infoDictionary["CFBundleShortVersionString"] as? String
        else { return nil }
