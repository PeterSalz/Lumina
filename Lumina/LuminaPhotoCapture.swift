...
struct LuminaPhotoCapture
{
    ...
    fileprivate func collectionUpdated()
    {
        ...
        guard let sendingCamera = camera,
        ...
        DispatchQueue.main.async
        {
            ...
            sendingCamera.delegate?.stillImageCaptured(camera: sendingCamera,
                                                       image: image,
                                                       livePhotoURL: sendingLivePhotoURL,
                                                       depthData: sendingDepthData)
        }
    }
}
