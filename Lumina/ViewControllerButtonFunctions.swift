...
extension LuminaViewController
{
    ...
    func shutterButtonTapped()
    {
        ...
        UIView.animate(withDuration: 0.25,
                       animations: { self.previewLayer.opacity = 1 })
    ...
    @objc
    func shutterButtonLongPressed(_ sender: UILongPressGestureRecognizer)
    {
    ...
    func torchButtonTapped()
    {
        ...
        else
        {
            ...
            self.torchButton.updateTorchIcon(to: .off)
        ...
        case .off:
            ...
            self.torchButton.updateTorchIcon(to: .on)
        ...
        case .on(_):
            ...
            self.torchButton.updateTorchIcon(to: .auto)
